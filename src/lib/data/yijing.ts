// 周易六十四卦数据（文言原文，仅卦辞/爻辞）
// 来源：以 liujuntao123/yijing 为蓝本，经 Wikisource《周易》(王弼注本) 与 ctext 校对勘正
// bits: 自下而上六爻，1=阳 0=阴

export interface YiLine {
  name: string;
  text: string;
}
...
export const HEXAGRAMS: Hexagram[] = [
  ...
  },
  {
    ...
    "lines": [
      ...
      {
        "name": "上六",
        "text": "迷复，凶，有灾眚。用行师，终有大败，以其国君凶，至于十年，不克征。"
      }
    ]
  },
  {
